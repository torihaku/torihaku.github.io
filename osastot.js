$(document).ready(function() {
    ...
    function addSelectedCategory(checkbox) {
        ...
        var selectedItem = $('<p class="selected-osasto border border-gray-200 dark:border-gray-600 inline-block text-sm mr-2 mb-2 py-1 pr-2 h-8 pl-3 dark:text-white bg-gray-100 dark:bg-gray-700 rounded-full cursor-pointer whitespace-nowrap">')
